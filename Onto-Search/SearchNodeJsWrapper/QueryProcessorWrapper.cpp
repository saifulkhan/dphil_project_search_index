...
void QueryProcessorWrapper::Init(v8::Handle<v8::Object> exports)
{
    ...
    tpl->PrototypeTemplate()->Set(v8::String::NewSymbol("buildTreemap"),
    v8::FunctionTemplate::New(buildTreemap)->GetFunction());

    tpl->PrototypeTemplate()->Set(v8::String::NewSymbol("zoomTreemap"),
    v8::FunctionTemplate::New(zoomTreemap)->GetFunction());

    tpl->PrototypeTemplate()->Set(v8::String::NewSymbol("changeTreemapDepth"),
    v8::FunctionTemplate::New(changeTreemapDepth)->GetFunction());
...
v8::Handle<v8::Value> QueryProcessorWrapper::buildTreemap(const v8::Arguments& args)
{
    cout << "QueryProcessorWrapper::buildTreemap" << endl;
    ...
    string jsondata = obj->m_queryprocessor.buildTreemap(x, y, width, height);
...
v8::Handle<v8::Value> QueryProcessorWrapper::zoomTreemap(const v8::Arguments& args)
{
    cout << "QueryProcessorWrapper::zoomTreemap" << endl;
    ...
    QueryProcessorWrapper* obj = ObjectWrap::Unwrap<QueryProcessorWrapper>(args.This());
    string jsondata = obj->m_queryprocessor.zoomTreemap(pathString);
    v8::Local<v8::String> value = v8::String::New(jsondata.c_str());
...
v8::Handle<v8::Value> QueryProcessorWrapper::changeTreemapDepth(const v8::Arguments& args)
{
    cout << "QueryProcessorWrapper::changeTreemapDepth" << endl;
    ...
    QueryProcessorWrapper* obj = ObjectWrap::Unwrap<QueryProcessorWrapper>(args.This());
    string jsondata = obj->m_queryprocessor.changeTreemapDepth(depth);
    v8::Local<v8::String> value = v8::String::New(jsondata.c_str());
