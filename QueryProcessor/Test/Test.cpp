...
string query2 = "{\"key\":\"draft apple\"\",\"type\":\"docx pdf xlsx\",\"sizefrom\":\"\",\"sizeto\":\"\",\"datefrom\":\"\",\"dateto\":\"\"}";
string query3 = "{\"key\":\"draft\",\"type\":\"\",\"sizefrom\":\"\",\"sizeto\":\"\",\"datefrom\":\"\",\"dateto\":\"\"}";
...
void test_treemap()
{
    ...
    // build & 2 depth
    cout << qp.treemap(10, 10, 800, 400) << endl;
    // depth
    cout << qp.treemap(2) << endl;
    cout << qp.treemap(3) << endl;
    cout << qp.treemap(4) << endl;
